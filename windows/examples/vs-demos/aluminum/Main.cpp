...
int main() {
    ...
    VertexDisplacement().start("Aluminum: Week4a VertexDisplacement", 400, 300);
    ModelFromObjFile().start("Aluminum: Week4b ModelFromObjFile", 400, 300);
    NoiseSphere().start("Aluminum: Week5a NoiseSphere", 400, 300);
    SkyBox().start("Aluminum: Week5b SkyBox", 400, 300);
    MiniPlanet().start("Aluminum: Week5c MiniPlanet", 400, 300);
    WBOIT().start("Aluminum: Week5d WBOIT", 400, 300);
    ImageProcessing().start("Aluminum: Week6a ImageProcessing", 400, 300);
    Billboarding().start("Aluminum: Week6b Billboarding", 400, 300);
