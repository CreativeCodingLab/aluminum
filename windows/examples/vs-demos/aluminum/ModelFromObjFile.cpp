...
class ModelFromObjFile : public RendererWin32 {
public:
  ...
  virtual void onCreate() {
    ...
    rh.loadProgram(program, "week4b_LoadObjFiles/phong", posLoc, normalLoc, -1, -1);

    MeshData modelMesh[3];

    loadObjIntoMesh(modelMesh[0], "week4b_LoadObjFiles/dragon.obj", 2.5);
    loadObjIntoMesh(modelMesh[1], "week4b_LoadObjFiles/bunny.obj", 1.0);
    loadObjIntoMesh(modelMesh[2], "week4b_LoadObjFiles/willis.obj", 1.0);
