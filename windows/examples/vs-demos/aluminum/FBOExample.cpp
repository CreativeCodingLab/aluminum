...
public:
  ...
  void onCreate() {
    ...
    rh.loadTexture(texture, "week3b_RenderToTexture/hubble.jpg");
    texture.minFilter(GL_NEAREST);
    texture.maxFilter(GL_NEAREST);

	rh.loadProgram(textureProgram, "week3b_RenderToTexture/texture", posLoc, -1, texCoordLoc, -1);
    rh.loadProgram(phongProgram, "week3b_RenderToTexture/phong", posLoc, normalLoc, texCoordLoc, -1);
	rh.loadProgram(programColor, "week3b_RenderToTexture/color", posLoc, normalLoc, -1, colorLoc);
