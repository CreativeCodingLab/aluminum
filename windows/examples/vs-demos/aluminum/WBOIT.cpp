...
class WBOIT : public RendererWin32 {
...
public:
  ...
  void onCreate() {
    ...
    rh.loadProgram(blendPassProgram, "week5d_OrderIndependentBlending/blendpass", posLoc, -1, -1, -1);
    rh.loadProgram(finalProgram, "week5d_OrderIndependentBlending/final", posLoc, -1, texCoordLoc, -1);
