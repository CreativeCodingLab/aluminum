...
uniform mat4 m; //a matrix that defines how points in object space are transformed to object space (or model space)
uniform mat4 v; //a matrix that defines how points in object space are transformed to camera / eye space (or view space)
uniform mat4 p; //a matrix that defines how a points are projected from 3D to 2D
