...
class ModelFromObjFile : public RendererLinux {
public:
  ...
  virtual void onCreate() {
    ...
    loadObjIntoMesh(modelMesh[0], "resources/dragon.obj", 2.5);
    loadObjIntoMesh(modelMesh[1], "resources/bunny.obj", 1.0);
    loadObjIntoMesh(modelMesh[2], "resources/willis.obj", 1.0);
...
int main()
{
	ModelFromObjFile().start("ModelFromObjFile");
	return 0;
}
