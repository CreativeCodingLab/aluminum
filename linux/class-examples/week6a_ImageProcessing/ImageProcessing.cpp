...
class ImageProcessing : public RendererLinux {
...
public:
  ...
  void onCreate() {
    ...
    rh.loadTexture(textures[0], "resources/hubble.jpg");
    rh.loadTexture(textures[1], "resources/angus.jpg");
    rh.loadTexture(textures[2], "resources/family.jpg");
    rh.loadTexture(textures[3], "resources/stainedglass.jpg");
...
int main() {
	ImageProcessing().start("ImageProcessing");
	return 0;
}
