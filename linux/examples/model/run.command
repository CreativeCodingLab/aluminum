...
g++ -Wno-write-strings $SRC_DIR/*.cpp $LINUX_DIR/*.cpp $EXAMPLE_DIR/*.cpp -std=c++11 -I/usr/include/c++/4.6/x86_64-linux-gnu/ -I/usr/include/x86_64-linux-gnu/ -I/usr/include/c++/4.6/ -I/usr/include/ -I/usr/local/include/ -isysroot -I./ -I$LINUX_DIR -I$SRC_DIR -I$LINUX_DIR/include  -o $EXAMPLE_DIR/Model -lglut -lGL -lassimp -lfreeimage -lm 
